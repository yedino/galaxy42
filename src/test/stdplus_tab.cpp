...
TEST(stdplus_tab, tab_view_at){
	...
	EXPECT_EQ(20, tab_view_from_c_array.size());
	...
	EXPECT_EQ(10, tab_view_from_part_of_vec.size());
	...
	EXPECT_EQ(10, tab_view_from_part_of_c_array.size());
	...
	EXPECT_EQ(10, tab_view_from_part_of_std_array.size());
	...
	EXPECT_EQ(0, empty_tab_view_from_vec.size());
	EXPECT_EQ(0, empty_tab_view_from_c_array.size());
	EXPECT_EQ(0, empty_tab_view_from_std_array.size());
