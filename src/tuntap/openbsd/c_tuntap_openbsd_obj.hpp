...
class c_tuntap_openbsd_obj final : public c_tuntap_base_obj {
    using sys_functions_wrapper = c_tuntap_system_functions;
    using stream_type = boost::asio::posix::stream_descriptor;

public:
    c_tuntap_openbsd_obj(); ///< construct this object, throws if error
    c_tuntap_openbsd_obj(boost::asio::io_service &io_service);
    ~c_tuntap_openbsd_obj();
