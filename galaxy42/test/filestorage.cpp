...
TEST(filestorage, create_path) {
	...
	fs::path PRV_full = filestorage::prepare_file_for_write(e_filestore_wallet_galaxy_ipkeys_PRV, "key", true);
	...
	fs::path pub_full = filestorage::prepare_file_for_write(e_filestore_galaxy_ipkeys_pub, "key", true);
	...
	fs::path pub_full01 = filestorage::prepare_file_for_write(e_filestore_galaxy_ipkeys_pub, "key01", true);
	fs::path pub_full02 = filestorage::prepare_file_for_write(e_filestore_galaxy_ipkeys_pub, "key02", true);

	// saving data
	filestorage::save_string(e_filestore_galaxy_ipkeys_pub, "key01", "public data01", true);
	filestorage::save_string(e_filestore_galaxy_ipkeys_pub, "key02", "public data02", true);
	...
	fs::path PRV_full01 = filestorage::prepare_file_for_write(e_filestore_wallet_galaxy_ipkeys_PRV, "key01", true);
	fs::path PRV_full02 = filestorage::prepare_file_for_write(e_filestore_wallet_galaxy_ipkeys_PRV, "key02", true);
	...
	// saving data
	filestorage::save_string_mlocked(e_filestore_wallet_galaxy_ipkeys_PRV, "key01", l_str01, true);
	filestorage::save_string_mlocked(e_filestore_wallet_galaxy_ipkeys_PRV, "key02", l_str02, true);
