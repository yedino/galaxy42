...
class generator {
	...
	public:
		 ...
		 */
		///@{
		void push_vector_string(const std::vector<std::string> & data); ///< Save std::vector<string>

		template <typename T>
		void push_vector_object(const std::vector<T> & data); ///< Save std::vector<T>

		template <typename TKey, typename TVal>
		void push_map_object(const std::map<TKey,TVal> & data); ///< Save this map

		/**
		 * @brief Saves object T, also used by e.g. push_std::vector_object.
...
class parser {
	...
	public:
		 ...
		 */
		///@{
		std::vector<std::string> pop_vector_string(); ///< Decode a std::vector<string> object saved with push_std::vector_string

		template <typename T>
		std::vector<T> pop_vector_object(); ///< Decode std::vector<T> saved with push_std::vector_object<T>
		...
		/**
		 * @brief Loads object T, also used by e.g. pop_std::vector_object.
		 * @note If you will use this API then you must provide special function,
