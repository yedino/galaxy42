...
//      oss << "Program build options: " << endl;
        oss << mo_file_reader::gettext("L_program_build_options") << endl;

//      oss << "Code level: normal code: " << enabled_or_disabled( EXTLEVEL_IS_NORMAL ) << endl;
        oss << mo_file_reader::gettext("L_CL_normal_code") << enabled_or_disabled( EXTLEVEL_IS_NORMAL ) << endl;

//      oss << "Code level: preview code: " << enabled_or_disabled( EXTLEVEL_IS_PREVIEW ) << endl;
        oss << mo_file_reader::gettext("L_CL_previwew_code_") << enabled_or_disabled( EXTLEVEL_IS_PREVIEW ) << endl;

//      oss << "Code level: experimental code: " << enabled_or_disabled( EXTLEVEL_IS_EXPERIMENT ) << endl;
        oss << mo_file_reader::gettext("L_CL_experimental_code") << enabled_or_disabled( EXTLEVEL_IS_EXPERIMENT ) << endl;

//      oss << "Code level: experimental dangerous code: " << enabled_or_disabled( EXTLEVEL_IS_EXPERIMENT_DANGEROUS ) << endl;
        oss << mo_file_reader::gettext("L_CL_experimental_dangerous_code") << enabled_or_disabled( EXTLEVEL_IS_EXPERIMENT_DANGEROUS ) << endl;

//      oss << "Enabled features: " << endl;
        oss << mo_file_reader::gettext("L_enabled_features") << endl;

//      oss << "  * NTRU: " << enabled_or_disabled( ENABLE_CRYPTO_NTRU ) << endl;
        oss << mo_file_reader::gettext("L_NTRU") << enabled_or_disabled( ENABLE_CRYPTO_NTRU ) << endl;

//      oss << "  * SIDH: " << enabled_or_disabled( ENABLE_CRYPTO_SIDH ) << endl;
        oss << mo_file_reader::gettext("L_SIDH") << enabled_or_disabled( ENABLE_CRYPTO_SIDH ) << endl;
