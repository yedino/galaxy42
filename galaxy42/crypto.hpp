...
: public c_crypto_system
{
	private:
		...
		///@{
		/// @name Extra data created as result of KEX:

		/// Generated by me data for packet-start: the kexasym part (e.g. Ntru passwords I created randomly)
		std::string m_packetstart_kexasym;
		/// Our count: how many keys we have of each crypto system
		t_crypto_system_count m_cryptolists_count;
		///@}
