 ...
 * @warningUse only if you are sure that this code is unreachable, because it silences warnings.
 */
#define DEAD_RETURN_I_AM_SURE() do { { _erro("Reached unexpected end of function (DEAD_RETURN), aborting.");  std::abort(); } } while (0)
